document.addEventListener('DOMContentLoaded', ()=>{
    ...
    let scoreResult = document.getElementById('result')
    let grid = document.getElementById('grd')
    let gameOver =  document.getElementById('lose')
    ...
    function startGame(){
        ...
        scoreResult.style.justifyContent = 'center'
